...
def encode_data(model, data_loader, exp, log_step=10, logging=print):
    """Encode all images and captions loadable by `data_loader`"""
    batch_time, val_logger = exp.encode_data_start_callback()
    ...
    for i, (images, captions, lengths, ids) in enumerate(data_loader):
        ...
        model.loss(img_emb, cap_emb, cap_len)
...
def shard_xattn_t2i(images, captions, caplens, params, shard_size=128):
    """
...
def shard_xattn_i2t(images, captions, caplens, params, shard_size=128):
    """
