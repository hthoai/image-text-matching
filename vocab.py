...
def load_rdrsegmenter():
    ...
    return VnCoreNLP(str(VNCORE_PATH/'VnCoreNLP-1.1.1.jar'), annotators="wseg", max_heap_size='-Xmx500m')

class Vocabulary(object):
    def __init__(self, word2id: Optional[dict] = {}, id2word: Optional[List[int]] = [], n_word: Optional[int] = 0):
